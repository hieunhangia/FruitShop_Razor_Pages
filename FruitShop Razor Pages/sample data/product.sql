...
VALUES ('Táo đỏ',
       ...
       ('Cam sành',
        ...
        (SELECT "Id" FROM "ProductUnits" WHERE "Name" = 'Kg'), 'images/products/3.jpg',
        true, 65, 0, 2),
       ('Cam vàng',
       ...
       ('Mãng cầu',
        ...
        (SELECT "Id" FROM "ProductUnits" WHERE "Name" = 'Kg'), 'images/products/32.jpg',
        true, 38, 0, 31),
       ('Demo1', 'Demo', 360, (SELECT "Id" FROM "ProductUnits" WHERE "Name" = 'Kg'),
        'images/products/demo.png',
        true, 36, 0, 32),
