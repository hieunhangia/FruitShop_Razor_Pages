...
VALUES ('Táo đỏ',
        ...
        'http://localhost:9000/public/images/products/1.jpg', true, 58, 0),
       ('Táo vàng',
        ...
        'http://localhost:9000/public/images/products/2.jpg', true, 42, 0),
       ('Cam sành',
       ...
       ('Cam vàng',
        ...
        'http://localhost:9000/public/images/products/4.jpg', true, 39, 0),
       ('Chuối tiêu',
        ...
        'http://localhost:9000/public/images/products/5.jpg', true, 68, 0),
       ('Dâu tây',
        ...
        'http://localhost:9000/public/images/products/6.jpg', true, 37, 0),
       ('Dưa hấu',
        'Dưa hấu mọng nước, ngọt thanh, giàu lycopene và vitamin C. Phù hợp ăn trực tiếp, làm nước ép hoặc tráng miệng giải khát.',
        25000, (SELECT "Id" FROM "ProductUnits" WHERE "Name" = 'Kg'),
        'http://localhost:9000/public/images/products/7.jpg', true, 55, 0),
       ('Dưa lưới',
        ...
        'http://localhost:9000/public/images/products/8.jpg', true, 61, 0),
       ('Nho xanh',
        ...
        'http://localhost:9000/public/images/products/9.jpg', true, 48, 0),
       ('Nho đỏ',
        ...
        'http://localhost:9000/public/images/products/10.jpg', true, 53, 0),
       ('Nho tím',
        ...
        'http://localhost:9000/public/images/products/11.jpg', true, 40, 0),
       ('Xoài cát',
        'Xoài cát Hòa Lộc, vàng ươm, thơm ngọt, thịt mềm, giàu vitamin A và C. Phù hợp ăn trực tiếp hoặc làm sinh tố, kem trái cây.',
        60000, (SELECT "Id" FROM "ProductUnits" WHERE "Name" = 'Kg'),
        'http://localhost:9000/public/images/products/12.jpg', true, 69, 0),
       ('Xoài tượng',
        ...
        'http://localhost:9000/public/images/products/13.jpg', true, 36, 0),
       ('Xoài keo',
        'Xoài keo chín vàng, ngọt mát, thịt mềm, giàu vitamin A và C. Phù hợp ăn trực tiếp hoặc làm sinh tố, kem trái cây.',
        50000, (SELECT "Id" FROM "ProductUnits" WHERE "Name" = 'Kg'),
        'http://localhost:9000/public/images/products/14.jpg', true, 50, 0),
       ('Dừa xiêm',
        ...
        'http://localhost:9000/public/images/products/15.jpg', true, 63, 0),
       ('Dưa chuột',
        ...
        'http://localhost:9000/public/images/products/16.jpg', true, 44, 0),
       ('Bưởi da xanh',
       ...
       ('Kiwi',
        ...
        'http://localhost:9000/public/images/products/21.jpg', true, 60, 0),
       ('Mơ',
        'Mơ chín mọng, vị ngọt nhẹ và hơi chua, giàu vitamin A, C, chất chống oxy hóa. Ăn trực tiếp hoặc làm mứt, nước ép.',
        60000, (SELECT "Id" FROM "ProductUnits" WHERE "Name" = 'Kg'),
        'http://localhost:9000/public/images/products/22.jpg', true, 54, 0),
       ('Ổi',
        ...
        'http://localhost:9000/public/images/products/23.jpg', true, 43, 0),
       ('Măng cụt',
        ...
        'http://localhost:9000/public/images/products/24.jpg', true, 67, 0),
       ('Hồng giòn',
        ...
        'http://localhost:9000/public/images/products/25.jpg', true, 39, 0),
       ('Đu đủ',
        'Đu đủ chín vàng, ngọt mát, giàu vitamin A, C và enzyme papain hỗ trợ tiêu hóa. Ăn trực tiếp hoặc làm sinh tố.',
        30000, (SELECT "Id" FROM "ProductUnits" WHERE "Name" = 'Kg'),
        'http://localhost:9000/public/images/products/26.jpg', true, 59, 0),
       ('Cherry',
        ...
        'http://localhost:9000/public/images/products/27.jpg', true, 49, 0),
       ('Táo xanh',
        'Táo xanh Granny Smith, vị chua ngọt đặc trưng, giàu pectin và chất xơ. Thích hợp ăn trực tiếp, làm bánh hoặc salad.',
        55000, (SELECT "Id" FROM "ProductUnits" WHERE "Name" = 'Kg'),
        'http://localhost:9000/public/images/products/28.jpg', true, 62, 0),
       ('Bưởi hồng',
        ...
        'http://localhost:9000/public/images/products/29.jpg', true, 46, 0),
       ('Vải thiều',
        ...
        'http://localhost:9000/public/images/products/30.jpg', true, 56, 0),
       ('Nhãn',
        'Nhãn tươi ngọt thanh, thịt trắng trong, giàu vitamin C và glucose tự nhiên. Ăn trực tiếp hoặc nấu chè, làm mứt.',
        60000, (SELECT "Id" FROM "ProductUnits" WHERE "Name" = 'Kg'),
        'http://localhost:9000/public/images/products/31.jpg', true, 64, 0),
       ('Mãng cầu',
